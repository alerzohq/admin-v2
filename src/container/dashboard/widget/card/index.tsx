...
import { amountConverter, numberWithCommas } from '../../../../utils/formatValue'
  ...
  return (
    <CardWidgetWrapper>
      <CardWidgetBox
        ...
        value={`N${stats?.totalDeposits ? 
          amountConverter(stats?.totalDeposits)
        :'0'}`}
        loading={loading}
      />
      <CardWidgetBox
        ...
        value={`N${stats?.totalWithrawals ? 
          amountConverter(stats?.totalWithrawals)
        :'0'}`}
        loading={loading}
      />
      <CardWidgetBox
