...
import { DepositIcon, TransCountIcon, UsersSolidIcon, WithDrawIcon } from '../../../../assets/icons'
...
const CardWidget = () => {
  return (
    <CardWidgetWrapper>
        ...
        <CardWidgetBox Icon={TransCountIcon} text={'Total Number of Transactions'} value={'50,000'} />
