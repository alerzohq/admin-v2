...
type Props = {
    ...
    setValue: React.Dispatch<React.SetStateAction<{ reassignmentReason?: string; businessId?: string }>>
}
const EnableTerminalWidget = ({ loading, data, isShown, value, toggleModal, setValue, handleSubmit }: Props) => {
    console.log(isShown)
