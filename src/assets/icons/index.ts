...
export { default as ActiveKYCIcon } from './active-KYC'
export { default as SuccessIcon } from './success-icon'
export{default as BillerIcon}from'./biller-icon'
export{default as ActiveBillerIcon}from'./active-biller'
export{default as ArrowUpIcon}from'./arrow-up'
export{default as AlerzoLogoWhite}from'./alerzo-logo-white'
