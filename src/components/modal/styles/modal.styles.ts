...
export const Content = styled.div<props>`
  ...
  flex-direction: column;
  align-item: center;
  padding: ${({contentPadding})=> contentPadding ? contentPadding :"2em 3.5em"};
...
height:100px;
height: ${({textAreaHeight})=> textAreaHeight ? textAreaHeight : "300px"};
border-radius:.6rem;
margin-top: ${({textAreaTopMargin})=>textAreaTopMargin ? textAreaTopMargin : '1rem'};
padding: .5rem;
outline: none;
resize: none;
font-size:.8rem;
