...
import { Body, ButtonWrapper, Header, Item, ReceiptItem, ReceiptWrapper } from "./styles/centered-card.styles";
import { ButtonRowProps, CenteredCardProps } from "./type";

const CenteredCardItem = ({ leftTitle, rightTitle, leftText, rightText, weight, color }: CenteredCardProps) => {
    return (
        <>
            <Item>
                <Text as='p'
    ...
    return (
        ...
        <ReceiptWrapper>
            <ReceiptItem bgImage={signoutlogout}>
                ...
                <CenteredCard.ButtonRow leftButtonClick={() => { }} rightButtonClick={() => { }} />
